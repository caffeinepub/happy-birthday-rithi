...
function useBirthdayMusic() {
  ...
  const playMelody = reactExports.useCallback(() => {
  ...
  const startMusic = reactExports.useCallback(() => {
    ...
    setIsPlaying(true);
    const loopDuration = melody.reduce((acc, [, dur]) => acc + dur + 0.05, 0) + 1.2;
    const loop = () => {
      if (!isPlayingRef.current) return;
      playMelody();
      setTimeout(() => {
  ...
  const stopMusic = reactExports.useCallback(() => {
    ...
    if (gainRef.current) {
      gainRef.current.gain.linearRampToValueAtTime(
        0,
        (((_a2 = audioCtxRef.current) == null ? void 0 : _a2.currentTime) ?? 0) + 0.5
      );
    }
  }, []);
...
function BalloonSvg({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      role: "img",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Balloon" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "30", cy: "30", rx: "28", ry: "30", fill: color }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "22", cy: "20", rx: "8", ry: "6", fill: "white", opacity: "0.2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "30", y1: "60", x2: "30", y2: "80", stroke: color, strokeWidth: "2" })
      ]
    }
  );
}
function FloatingBalloons({
  ...
  const [balloons] = reactExports.useState(() => genBalloons(count));
    ...
    "div",
    {
      ...
      children: balloons.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(BalloonSvg, { color: b.color, width: "100%", height: "100%" })
        },
        b.id
      ))
    }
...
function SideBalloons() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", inset: 0, pointerEvents: "none" }, children: [
    leftColors.map((color, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "absolute",
    ...
    rightColors.map((color, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "absolute",
...
function ConfettiBurst({ active }) {
  const [pieces] = reactExports.useState(() => genConfetti(50));
  if (!active) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function FloatingHearts({ active }) {
  const [hearts] = reactExports.useState(() => genHearts(12));
  if (!active) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function Sparkles({ active }) {
  const [sparkles] = reactExports.useState(() => genSparkles(16));
  if (!active) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0, pointerEvents: "none" }, children: sparkles.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
        position: "absolute",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
        ...
        animation: visible ? "slideTransitionIn 0.6s ease-out forwards" : "none",
        opacity: visible ? 1 : 0,
...
function GlowName({ style: style2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      style: {
...
function Slide1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SideBalloons, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiBurst, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", zIndex: 10, position: "relative" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(GlowName, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          style: {
...
function Slide2() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingBalloons, { count: 10, active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", zIndex: 10, position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "The day the world got a little more beautiful"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "You are 19 today, Rithi ♥"
        }
      )
    ] }) })
  ] });
...
function Slide3() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingHearts, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          textAlign: "center",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { margin: "1.2rem 0" }, children: lines.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
                fontFamily: "'Poppins', sans-serif",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", zIndex: 10, position: "relative" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: lines.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                animation: `popIn 0.6s ${0.6 + i * 0.2}s ease-out both`,
                background: "linear-gradient(135deg, rgba(198,26,34,0.15), rgba(42,11,13,0.4))",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "clamp(1.5rem, 4vw, 2.5rem)" }, children: line.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", zIndex: 10, position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Two Souls, One Heartbeat"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          style: {
            ...
            animation: "fadeSlideUp 0.8s 0.4s ease-out both, shimmer 3s linear infinite",
            lineHeight: 1,
            marginBottom: "0.5rem"
          },
          children: "AmiRithi"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          style: {
            animation: "heartPulse 1.5s ease-in-out infinite, fadeSlideUp 0.8s 0.8s ease-out both",
            fontSize: "clamp(1.5rem, 4vw, 2.5rem)",
            fontFamily: "'Poppins', sans-serif",
            fontWeight: 700,
            color: "#F4F2F2",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: [{ delay: 0 }, { delay: 0.3 }, { delay: 0.6 }].map(({ delay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
                color: "#D51E2A",
...
function Slide6() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingBalloons, { count: 12, active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiBurst, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
                ...
                fontWeight: 700,
                color: "#F4F2F2",
                animation: "glowPulse 2s ease-in-out infinite, fadeSlideUp 0.8s 0.4s ease-out both",
                marginBottom: "1.5rem"
              },
              children: "Rithi"
            }
          ),
          wishes.map((wish, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
                fontFamily: "'Poppins', sans-serif",
...
function Slide7() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SideBalloons, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiBurst, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingBalloons, { count: 15, active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingHearts, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", zIndex: 10, position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            ...
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            animation: "shimmer 2s linear infinite, fadeSlideUp 0.8s 0.6s ease-out both",
            lineHeight: 1,
            marginBottom: "0.5rem"
          },
          children: "RITHI!"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "From Lucky, with all my love"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: ["🎂", "🎉", "🎈", "💝", "🎊"].map((emoji, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
                fontSize: "clamp(1.5rem, 4vw, 2.5rem)",
...
function Slide8() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SideBalloons, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingBalloons, { count: 18, active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiBurst, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingHearts, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { active: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SlideWrapper, { visible: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: [
                ...
                { e: "👑", k: "crown" },
                { e: "🌟", k: "star-right" }
              ].map(({ e, k }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "✦ Your Dreams Are Waiting ✦"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                fontWeight: 700,
                background: "linear-gradient(135deg, #C61A22 30%, #FFD700 60%, #C61A22 90%)",
                backgroundSize: "200% auto",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                animation: "shimmer 2.5s linear infinite, fadeSlideUp 0.8s 0.35s ease-out both",
                lineHeight: 1,
                marginBottom: "0.1rem",
                textShadow: "none"
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Born to Lead · Future Star"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ambitions.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                    animation: `popIn 0.6s ${a.delay}s ease-out both`,
                    background: "linear-gradient(135deg, rgba(255,215,0,0.08), rgba(198,26,34,0.15))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "0.7rem" }, children: inspoLines.map(({ text, delay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
                fontFamily: "'Poppins', sans-serif",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ["⚖️", "🏛️", "👑", "🌟", "💫"].map((emoji, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
...
function App() {
  ...
  const goTo = reactExports.useCallback(
    (index2) => {
      ...
      const next = index2 < 0 ? 0 : index2 >= SLIDES.length ? 0 : index2;
  ...
  const handleForward = reactExports.useCallback(() => goTo(current + 1), [goTo, current]);
  const handleBack = reactExports.useCallback(() => goTo(current - 1), [goTo, current]);
  reactExports.useEffect(() => {
    const handleKey = (e) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "main",
    {
      ...
      style: {
        width: "100vw",
        height: "100vh",
        background: "radial-gradient(ellipse at center, #2A0B0D 0%, #0B0B0D 70%)",
        position: "relative",
        overflow: "hidden",
        fontFamily: "'Poppins', sans-serif"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0, pointerEvents: "none" }, children: [
        ...
        ].map(({ left, top, size, dur, delay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SlideComponent, {})
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1rem" }, children: isPlaying ? "🎵" : "🎶" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["s1", "s2", "s3", "s4", "s5", "s6", "s7", "s8"].map((name, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              nav.back && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              nav.forward && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
